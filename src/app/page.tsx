    ...
    <div className="flex flex-col h-screen" style={{ background: 'var(--bg)' }}>
      ...
      <main className="flex-1 overflow-y-auto px-3 py-4 space-y-2.5">
        ...
        {messages.map((m) => (
          ...
          >
            <div
              className="max-w-[78%] px-3.5 py-2.5 text-[15px] leading-relaxed whitespace-pre-wrap break-words md-content"
              style={{
        ...
        {searchStatus.type === 'searching' && (
          <div className="flex justify-start">
            <div
              className="px-3.5 py-2 text-[13px] rounded-full"
              style={{ background: 'var(--bubble-assistant)', color: 'var(--text-dim)' }}
            >
              Searching the web…
            </div>
          </div>
      ...
      {/* Input */}
      <footer className="shrink-0 px-3 py-3 border-t" style={{ borderColor: 'var(--border)', background: 'var(--header-bg)' }}>
